...
export default function About() {
   ...
   return (
      <ExtraPageLayout title="About Us">
         ...
         <br />
         We take privacy very seriously, and we will never share your personal information with anyone. We use industry-standard encryption to ensure that your confession remains secure and confidential.
         <br />
         <br />
         Thank you for choosing our website as your platform to share your secret confessions. We hope that you find solace in knowing that you're not alone, and we look forward to hearing from you.
         </p>
      </ExtraPageLayout>
   )
}
